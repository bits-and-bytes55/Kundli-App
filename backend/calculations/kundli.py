...
def get_house_significators(kp_planets, kp_ascendant):
    ...
    for h in range(1, 13):
        ...
        significators[str(h)] = {
            ...
            'grade_a': grade_a,
            'grade_a_abbrevs': [planet_abbrev[p] for p in grade_a],
            'grade_b': grade_b,
            'grade_b_abbrevs': [planet_abbrev[p] for p in grade_b],
            'grade_c': grade_c,
            'grade_c_abbrevs': [planet_abbrev[p] for p in grade_c],
            'grade_d': grade_d,
            'grade_d_abbrevs': [planet_abbrev[p] for p in grade_d],
