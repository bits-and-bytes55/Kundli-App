...
class ReportsTab extends StatelessWidget {
  ...
  Widget _doshaCard(String title, bool present, String report, String planet, int? house, {String? extraBadge}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: present ? AppColors.primary : AppColors.accent, width: 1.5),
      ),
      child: Padding(padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Icon(present ? Icons.warning_amber_rounded : Icons.check_circle_outline_rounded,
            color: present ? AppColors.primary : Colors.green, size: 24),
          const SizedBox(width: 8),
        ...
        Row(children: [
          Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
            decoration: BoxDecoration(
              color: present ? AppColors.primary : Colors.green,
    ...
    return Container(
      ...
      child: Padding(padding: const EdgeInsets.all(16), child: Column(children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
          ...
          Container(width: 1, height: 60, color: AppColors.accent),
  ...
  Widget _numBox(String label, String value, String planet) {
    return Column(children: [
      ...
      Text(value, style: const TextStyle(fontSize: 36, fontWeight: FontWeight.bold, color: AppColors.primary)),
